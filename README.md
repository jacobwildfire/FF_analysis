...
To download the repository from GitHub, there are two options. 
1. If you have limited experience with Git/GitHub, follow step 1a.
2. If you have experience with Git/GitHub and cloning repositories in RStudio, follow step 1b.

#### 1a. Downloading the repository from GitHub **(GitHub/Windows)**
The most simple way to download and initialise the repository is to download it directly from GitHub. To do this,

1. Click the <span style='color: green;'>green</span> *<> Code* button on the 'FF_analysis' GitHub repository page.
...
2. Copy the URL to your clipboard.
  - https://github.com/jacobwildfire/FF_analysis.git
  - This assumes that you are cloning the repository to your local system, and that you are using HTTPS to connect.
3. In RStudio, select *File → New Project → Version Control → Git*.
4. In “Repository URL”, paste the URL.
5. Choose your repository name.
  - If you would like to practise using the example data, keep things simple and set the repository name to 'FF_analysis-main'.
  - The code files assume that this is the repository's name. Note, it is different from the default, which is just 'FF_analysis'.
6. Choose where you are saving your directory.
...
2. Run each R file in numerical order.
	- Whilst not totally necessary, code files 2a and 2b are dependent on the outputs of code files 1a and 1b, respectively.

Code files will deposit excel their outputs into the 'FF_analysis-main/Output files/' folder.
Code files 2a to 3b will also open a `shiny` app, allowing you to modify and save your plots as you see fit.
